...
type Item struct {
	...
	VariantID                 int64          `json:"variant_id" bson:"variant_id" mapstructure:"variant_id"`
	...
	WarehouseProductVariantID int64          `json:"warehouse_product_variant_id" bson:"warehouse_product_variant_id" mapstructure:"warehouse_product_variant_id"`
	ProductTemplateID         int64          `json:"product_template_id" bson:"product_template_id" mapstructure:"product_template_id"`
	ExternalProductID         string         `json:"external_product_id" bson:"external_product_id" mapstructure:"external_product_id"`
	...
	Files                     []File         `json:"files" bson:"files" mapstructure:"files"`
	Options                   []Option       `json:"options" bson:"options" mapstructure:"options"`
